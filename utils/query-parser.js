...
function parseJSON(json, maxResults) {
  ...
  if (json["columns"] !== undefined) {
    ...
    //Check if siret is in "columns".
    if (!attributes.includes("siret")) {
      attributes.unshift("siret");
    }
  ...
  if (json["query"] !== undefined) {
    ...
    if (queryObj["siret"] === undefined) {
      queryObj["siret"] = {[Op.gt]: offset};
    }
